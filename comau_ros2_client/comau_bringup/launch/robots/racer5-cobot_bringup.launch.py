...
def generate_launch_description():
    ...
    xacro_file_path = os.path.join(get_package_share_directory('racer5-cobot_description'), 'robots', 'racer5-cobot_robot.urdf.xacro')    
    ...
    robot_description_file_arg = DeclareLaunchArgument(
       ...
       default_value=os.path.join(get_package_share_directory('racer5-cobot_description'),
                         'launch/racer5-cobot_upload.launch.py'),
