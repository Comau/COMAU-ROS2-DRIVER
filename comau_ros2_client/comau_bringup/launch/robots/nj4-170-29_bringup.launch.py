...
def generate_launch_description():
    ...
    xacro_file_path = os.path.join(get_package_share_directory('nj4-170-29_description'), 'robots', 'nj4-170-29_robot.urdf.xacro')    
    ...
    robot_description_file_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(get_package_share_directory('nj4-170-29_description'),
                         'launch/nj4-170-29_upload.launch.py'),
