...
//typedef rclcpp_action::SimpleActionServer<comau_msgs::action::ExecuteCartesianTrajectory> ExecuteCartesianTrajectoryActionServer;
...
public:
  ...
  using ExecuteCartesianTrajectory = comau_msgs::action::ExecuteCartesianTrajectory;
  using GoalHandleExecuteCartesianTrajectory = rclcpp_action::ServerGoalHandle<ExecuteCartesianTrajectory>;
...
private:
  rclcpp_action::Server<ExecuteCartesianTrajectory>::SharedPtr ExecuteCartesianTrajectoryActionServer;

  rclcpp_action::GoalResponse handle_goal(const rclcpp_action::GoalUUID & uuid, std::shared_ptr<const ExecuteCartesianTrajectory::Goal> goal);
  rclcpp_action::CancelResponse handle_cancel(const std::shared_ptr<GoalHandleExecuteCartesianTrajectory> goal_handle);
  void handle_accepted(const std::shared_ptr<GoalHandleExecuteCartesianTrajectory> goal_handle);
   ...
   */
  trajectoryf_t parseCartesianTrajectoryGoal(std::shared_ptr<const comau_msgs::action::ExecuteCartesianTrajectory::Goal> goal);
  /**
   * @brief A callback function that handles the incoming goal
   *
   * @param goal see comau_msgs::ExecuteCartesianTrajectoryGoal
   */
  void executeCallback(const std::shared_ptr<GoalHandleExecuteCartesianTrajectory> goal);
  /**
  ...
  /*comau_msgs::action::ExecuteCartesianTrajectory::Feedback feedback_;
  comau_msgs::action::ExecuteCartesianTrajectory::Result result_;*/
  std::shared_ptr<ExecuteCartesianTrajectory::Feedback> feedback_;
  std::shared_ptr<ExecuteCartesianTrajectory::Result> result_;
  char robot_status_ = 'R'; // only initialized for dummy

  //boost::shared_ptr<ExecuteCartesianTrajectoryActionServer> as_ptr_;
  std::shared_ptr<GoalHandleExecuteCartesianTrajectory> goal_handle_;
