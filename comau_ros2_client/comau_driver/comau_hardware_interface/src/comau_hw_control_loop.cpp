...
{
ComauHWControlLoop::ComauHWControlLoop() : controller_interface::ControllerInterface() {}

controller_interface::CallbackReturn ComauHWControlLoop::on_init()
{
...
controller_interface::InterfaceConfiguration ComauHWControlLoop::command_interface_configuration()
  const
{
...
controller_interface::InterfaceConfiguration ComauHWControlLoop::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf = {config_type::INDIVIDUAL, {}};
...
controller_interface::CallbackReturn ComauHWControlLoop::on_configure(const rclcpp_lifecycle::State &)
{
  auto callback =
...
controller_interface::CallbackReturn ComauHWControlLoop::on_activate(const rclcpp_lifecycle::State &)
{
...
controller_interface::return_type ComauHWControlLoop::update(
...
controller_interface::CallbackReturn ComauHWControlLoop::on_deactivate(const rclcpp_lifecycle::State &)
{
  release_interfaces();
...
controller_interface::CallbackReturn ComauHWControlLoop::on_cleanup(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn ComauHWControlLoop::on_error(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn ComauHWControlLoop::on_shutdown(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}
...
PLUGINLIB_EXPORT_CLASS(
  comau_hardware_control_loop::ComauHWControlLoop, controller_interface::ControllerInterface)
